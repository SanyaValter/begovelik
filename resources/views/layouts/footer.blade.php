           ...
           <hr>
            <section class="">
                ...
                <div class="row mt-3">
                    ...
                    <p><i class="fas fa-phone me-3"></i> + 7 950 234 11</p>
                    <p><i class="fas fa-print me-3"></i> + 7 235 567 89</p>
                    </div>
                </div>
                </div>
            </section>
            <div class="container">
                <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                    <div class="col-md-4 d-flex align-items-center">
                      ...
                      <span class="mb-3 mb-md-0 mx-4">  <a class="text-reset fw-bold text-decoration-none" href="{{route('main')}}">БЕГОВЕЛиК</a> © 2023</span>
                    </div>
