...
<section>
  ...
  <section class="py-5">
    <div class="container">
      ...
      <p class="fs-5">Более того, занятия подарят здоровье, ведь велоспорт официально признан отличной профилактикой болезней сердца, сосудов, патологий легочной системы и нервных расстройств.</p>
      ...
      <p class="fs-5 text-start">Также отложить запись на занятие до полного выздоровления нужно при инфекционных и кожных заболеваниях, болезнях дыхательных путей, ЛОР заболеваниях и травмах.</p>
